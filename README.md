...
| **State**     | ![Zustand Logo](https://cdn.jsdelivr.net) + ![Immer](https://img.shields.io)                                                                                                                                                                                                                                                  | Optimized state management.              |
| **Data**      | ![Dexie logo](https://dexie.org)                                                                                                                                                                                                                                                                                              | IndexedDB wrapper for offline storage.   |
